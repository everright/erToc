 ...
 * Testd on: jQuery 1.2+, IE 6+, Firefox, Chrome, Safari, Oprea
...
(function($) {
    $.erToc = function(el, options) {
        ...
        base.initNodes = function() {
            var tag,
            nodes = base.options.nodes.splice(base.options.startLevel, base.options.maxLevel);
        ...
        */
        base.initToc = function() {
            ...
            base.$nodes.addClass(base.options.nodeClass).each(function(i, obj) {
                ...
                base.toc += base.formatLink(node, level);
        ...
        base.createToc = function() {
            ...
            if (!base.$target.length) {
                base.$target = $('<div id="er-toc"></div>').prependTo(base.$this);
            }
            ...
            if (base.options.tocScroll) {
                base.$toc.find('a').click(function() {
                    base.$body.animate({scrollTop: $($(this).attr('href')).offset().top}, base.options.scrollSpeed);
                    return false;
                });
            }
        };
        ...
        base.addGoTop = function() {
            ...
            top = $('<a href="#" class="' + base.options.goTopClass + '" title="' + text + '">' + text + '</a>').click(function() {
                base.$body.animate({scrollTop: base.$topNode.offset().top}, base.options.scrollSpeed);
                return false;
            });
         ...
         */
        base.formatLink = function(node, level) {
            var text = node.text(),
            ...
            return '<a href="#' + id + '" title="' + text + '"' + style + '>' + text + '</a>';
        };
        ...
        base.formatLevel = function(level, last) {
            ...
            var output = (level > base.currentLevel) ? base.formatTag(base.currentLevel, level, true) : base.formatTag(level, base.currentLevel) + ((true === last) ? base.formatTag(0, base.currentLevel) : base.listEC + base.listEO);
